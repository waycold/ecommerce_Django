...
from core.auth_views import validate_token_view
from product.internal_views import catalog_search_view
from analytics.internal_views import analytics_metrics_view
