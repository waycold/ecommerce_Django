...
def ai_chat_view(request):
    if request.method == 'POST':
        if not genai:
            return JsonResponse({'error': 'Google Generative AI SDK not installed or imported.'}, status=500)
        ...
        try:
            ...
            # Helper with exponential backoff for Google 500 transient errors
            ...
            if retry:
                ...
                response = retry_decorator(attempt_generation)()
            else:
                response = attempt_generation()
